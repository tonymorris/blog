---
comments: true
date: 2008-07-17 11:33:07
layout: post
slug: haskell-exercises-for-beginners
...
If you have not used Haskell before, download and install [GHC](http://haskell.org/ghc), start up the interpreter (ghci) and load the source file. e.g. `:load Exercises.hs` If you are on Debian, you can install GHC and start the interpreter with: `apt-get install ghc6 && ghci`.

The source file below can be found [here](https://bitbucket.org/dibblego/haskell-course/src/default/L02/List.hs).
